...
#define SUART_ICP_PORT PORTD
#define SUART_ICP_PIN  PIND
#define SUART_ICP_DDR  DDRD
#define SUART_ICP_BIT  PD6
...
void enable_rx(void){
    ...
    SUART_ICP_DDR  &= ~(1 << SUART_ICP_BIT);
    //SUART_ICP_PORT &= ~(1 << SUART_ICP_BIT);
